        ...
        <div className="flex justify-end items-center gap-4">
          ...
          {activeSection === "pending" && (
            <button
              ...
              className="flex items-center gap-2 bg-blue-500/20 dark:bg-[#0d2943] text-blue-600 dark:text-[#00d4ff] px-4 py-2 rounded-lg hover:bg-blue-500/30 dark:hover:bg-[#0a2540] transition-colors font-medium border border-blue-500/30 dark:border-[#1e3a5f]"
            >
