...
const InviteEmployeeForm: React.FC<InviteEmployeeFormProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-[#0d1f2d] rounded-lg border border-gray-200 dark:border-[#1e3a5f] overflow-hidden shadow-xl">
      {/* Header - Matching KB Form Style */}
      <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-[#1e3a5f] bg-white dark:bg-[#0d1f2d]">
